...
-- Tabla de: La Tienda de Informatica
...
-- 1.3
SELECT nombre, precio FROM articulos WHERE precio <= 200 ORDER BY precio DESC;
-- 1.4
SELECT nombre, precio FROM articulos WHERE precio BETWEEN 60 AND 120 ORDER BY precio DESC;
-- 1.5
...
-- 1.10
SELECT * FROM articulos WHERE precio=fabricantes.nombre;
